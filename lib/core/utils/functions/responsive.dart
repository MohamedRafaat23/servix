...
class ResponsiveUtils {
  ...
  static T valueByDeviceWithOrientation<T>({
    required BuildContext context,
    required T mobilePortrait,
    required T mobileLandscape,
    ...
    return switch ((device, orientation)) {
      (DeviceType.mobilePortrait, _) => mobilePortrait,
      (DeviceType.mobileLandscape, _) => mobileLandscape,
      (DeviceType.tablet, OrientationType.portrait) => tabletPortrait,
      (DeviceType.tablet, OrientationType.landscape) => tabletLandscape,
    };
  }
...
extension ResponsiveContext on BuildContext {
  ...
  T byDeviceWithOrientation<T>({
    required T mobilePortrait,
    required T mobileLandscape,
    required T tabletPortrait,
    required T tabletLandscape,
  }) =>
      ResponsiveUtils.valueByDeviceWithOrientation(
        context: this,
        mobilePortrait: mobilePortrait,
        mobileLandscape: mobileLandscape,
